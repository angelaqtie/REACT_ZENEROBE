...
const urlJollibeeLocal = "http://localhost/viter-zenorobe"; //from thunder client
export const imgPath = "http://localhost/viter-zenorobe/public/img"; //from thunder client
