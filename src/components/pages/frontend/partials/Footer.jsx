      ...
      <div className="container">
        <div className="grid md:grid-cols-[1.5fr,_1fr,_1fr,_.8fr] gap-5 mb-5">
          <div className="footer-box max-w-[400px]">
            <h6 className="mb-5">0ur Story</h6>
            <p>
              Our origin story is more of an origin statement. We wanted to
              design what we wanted to wear – so we did.
            </p>
            <p>
              Since then, that philosophy hasbecome more about the guy we design
              for and the impact he is looking to make. Our signature pieces,
              like the Sureshot Jogger and the Flintlock Tee, have come to stand
              for ingenuity, creativity and a constant drive to move forward and
              beyond expectations.
            </p>
            <p>
          ...
          <div className="footer-box">
            <h6 className="mb-5">0nline Store</h6>
            <ul>
              <li>
